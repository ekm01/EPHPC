...
\section{Optimization outside of TensorFlow} % (fold)
...
\bibitem{fifth}
Distributed training with TensorFlow (last updated on May 12, 2023) Retrieved from https://www.tensorflow.org/guide/distributed\textunderscore training
